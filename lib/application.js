  ...
  */
  ...
  mountMiddleWare() {
    ...
    middlewareList.forEach(function (mid) {
      ...
      const generatedMiddlewares = self.generateMiddleware(midConfig, middlewares);
  ...
  generateMiddleware(midConfig, middlewares) {
    let self = this;
    ...
    switch (type) {
      ...
      case 'array':
        ...
        midConfig.module.forEach(m => {
          ...
          const midInstances = self.generateMiddleware(newMidConfig, middlewares);
